...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Menu::create(["id" => 1, "order" => 1, "parent" => 0]);
        Menu::create(["id" => 2, "order" => 2, "parent" => 0]);
        Menu::create(["id" => 3, "order" => 3, "parent" => 0]);
        Menu::create(["id" => 4, "order" => 4, "parent" => 0]);
        Menu::create(["id" => 5, "order" => 5, "parent" => 0]);
        Menu::create(["id" => 6, "order" => 6, "parent" => 5]);
        Menu::create(["id" => 7, "order" => 7, "parent" => 5]);
        Menu::create(["id" => 8, "order" => 8, "parent" => 0]);
