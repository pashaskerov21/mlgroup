                ...
                <div class="col-12 col-lg-4">
                    <div class="footer-links">
                        ...
                        @foreach ($menues as $menu)
                            ...
                            @else
                            href="{{ url(Session('lang') . '/' . $menu->getTranslate->where('lang', Session('lang'))->first()->slug) }}" @endif>{{ $menu->getTranslate->where('lang', Session('lang'))->first()->title }}
                            </a> --}}
                            <a
                ...
                <div class="col-12 col-lg-4">
                    <div class="footer-links">
                        ...
                        @foreach ($services as $service)
                            <a
                                href="{{ route('service_inner_' . Session('lang'), ['slug' => $service->getTranslate->where('lang', Session('lang'))->first()->slug]) }}"><span>{{ $service->getTranslate->where('lang', Session('lang'))->first()->title }}</span></a>
                        @endforeach
                    </div>
                </div>
                <div class="col-12 col-lg-4">
